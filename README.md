'''
# Brahmai - Adaptive Quiz Application

This repository contains the source code for the Brahmai adaptive quiz application, a platform for personalized learning and assessment.
